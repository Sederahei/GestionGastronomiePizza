...
public class StockMovementTest package org.alherendro.dao;
...
class StockMovementDAOTest {
    ...
    void setUp() throws SQLException {
        ...
        try (Connection connection = DataSource.getConnection()) {
            ...
            String sql = """
                INSERT INTO stock_movement (id, ingredient_id, movement_type, quantity, unit, movement_datetime)
                VALUES 
                (1, 1, 'ENTREE', 100, 'U', '2025-02-01 08:00:00'),
                (2, 2, 'ENTREE', 50, 'U', '2025-02-01 08:00:00'),
                (3, 3, 'ENTREE', 10000, 'G', '2025-02-01 08:00:00'),
                (4, 4, 'ENTREE', 20, 'L', '2025-02-01 08:00:00');
                """;
